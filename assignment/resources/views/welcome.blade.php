...
<!-- Mirrored from massive.markup.themebucket.net/mp-index-blog-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:49:45 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper">
        ...
        <!--hero section-->
        <div class="banner-state text-center vertical-align banner-26 height-600">
            <div class="container-mid">
                <div class="container">
                    <div class="banner-box light-box">
                        <h2 class="text-uppercase ls-20"> Massive Blog</h2>
                            ...
                            <div class="blog-classic">
                                ...
                                <div class="blog-post">
                                    <div class="full-width">
                                        <img src="{{asset('assets/img/post/p12.jpg')}}" alt="" />
                                    </div>
                                            ...
                                            <ul class="slides">
                                                <li>
                                                    <a href="javascript:;" title="Freshness Photo">
                                                        <img src="{{asset('assets/img/post/p3.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:;" title="Awesome Lightbox">
                                                        <img src="{{asset('assets/img/post/p2.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:;" title="Massive UI Components">
                                                        <img src="{{asset('assets/img/post/p1.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="blog-classic">
                                ...
                                <div class="blog-post">
                                    <p class="video-fit m-bot-50">
                                        <iframe width="560" height="315" src="http://www.youtube.com/embed/lq_BVyou38s" allowfullscreen></iframe>
                                    </p>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="widget">
                                ...
                                <div class="full-width avatar">
                                    <img src="{{asset('assets/img/post/avatar.jpg')}}" alt="" />
                                </div>
                            ...
                            <div class="widget">
                                ...
                                <ul class="widget-latest-post">
                                    <li>
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('assets/img/post/post-thumb.jpg')}}" alt="" />
                                            </a>
                                        </div>
                                        <div class="w-desk">
                                    ...
                                    <li>
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('assets/img/post/post-thumb-2.jpg')}}" alt="" />
                                            </a>
                                        </div>
                                        <div class="w-desk">
                                    ...
                                    <li>
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="{{asset('assets/img/post/post-thumb-3.jpg')}}" alt="" />
                                            </a>
                                        </div>
                                        <div class="w-desk">
...
<!-- Mirrored from massive.markup.themebucket.net/mp-index-blog-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:49:49 GMT -->
</html>
